...
scanNavbarButton.addEventListener("click", ()=>{
    window.location.href = "../html/index.html"; //redirect to index.html (Homepage)
})

// About Us button page redirect functionality for Navbar.
aboutUsNavbarbutton.addEventListener("click", ()=>{
    window.location.href = "../html/aboutUsPage.html"; //redirect to aboutUsPage.html (About Us page)
})
...
techUsedNavbarbutton.addEventListener("click", ()=>{
    window.location.href = "../html/techUsedPage.html"; //redirect to techUsedPage.html (Technology Used page)
})
...
vulnerabilityDictNavbarbutton.addEventListener("click", ()=>{
    window.location.href = "../html/vulnerabilityDictPage.html"; //redirect to vulnerabilityDictPage.html (Vulnerability Dictionary page)
})
